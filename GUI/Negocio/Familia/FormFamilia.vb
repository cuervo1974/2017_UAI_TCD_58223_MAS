...
Public Class FormFamilia
    ...
    Private _Logica As New BLL.PATENTE

    Sub New(ByRef pObj As BE.FAMILIA)
        InitializeComponent()
        Me._Obj = pObj
    End Sub
    ...
    Private Sub TildarNodos(ByRef Nodos As TreeNodeCollection)
        For Each Nodo As TreeNode In Nodos
            For Each Patente As BE.PATENTE In Me._Obj.Patentes
                If Patente.Id = DirectCast(Nodo.Tag, BE.PATENTE).Id Then
                    Nodo.Checked = True
                End If
            Next
