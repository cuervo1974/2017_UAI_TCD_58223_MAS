Public Class FormClientes
    ...
    Private Sub RellenarDataGrid(pListado As List(Of BE.Cliente))
    ...
    Private Sub GetObjSeleccionado()
        ...
        If IsNothing(Me._Obj) Then Throw New Exception("No se ha seleccionado ningún Cliente.")
    End Sub

    Private Sub AbrirDialogo()
        Dim Dialogo As New FormCliente(Me._Obj)
        With Dialogo
            .TopMost = True
            .Show()
        End With
    ...
    Private Sub Eliminar()
        If Not Alertador.Alertar("¿Está seguro que desea eliminar el Cliente?", "Eliminar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then Exit Sub
        Try
            Me.GetObjSeleccionado()
