...
Public Class FormInventarioAlta

    Implements InterfaceObservador

    Private _Logica As New BLL.INVENTARIO_ALTA
    Private _Obj As BE.INVENTARIO_ALTA
    ...
    Private Sub RellenarDataGrid(pListado As List(Of BE.INVENTARIO_ALTA))
    ...
    Private Sub AbrirDialogo()
        Dim Dialogo As New FormInventarioAlta(Me._Obj)
        With Dialogo
            .TopMost = True
            .Show()
        End With
    ...
    Private Sub Agregar()
        Me._Obj = New BE.INVENTARIO_ALTA
        Me.AbrirDialogo()
    End Sub
    ...
    Private Sub Eliminar()
        If Not Alertador.Alertar("¿Está seguro que desea eliminar el Usuaurio?", "Eliminar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then Exit Sub
        Try
            Me.GetObjSeleccionado()
    ...
    Private Sub FormInventarioAlta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
