Public Class FormIdioma
    ...
    Sub New(ByRef pObj As BE.IDIOMA)
        InitializeComponent()
        Me._Obj = pObj
    End Sub
    ...
    Private Sub CargarPalabras()
        ...
        Me.DataGridViewTraducciones.Columns(0).Width = 200
        ...
        Me.DataGridViewTraducciones.Columns(1).Width = 200
        Me.DataGridViewTraducciones.AllowUserToAddRows = False
        For Each PalabraOriginal As BE.PALABRA In Me._Logica.ConsultarPalabrasOriginales
            Dim PalabraTraducida As BE.PALABRATRADUCIDA
            ...
            If IsNothing(PalabraTraducida) Then
                PalabraTraducida = New BE.PALABRATRADUCIDA(Nothing, PalabraOriginal, "")
    ...
    Private Sub DataGridViewTraducciones_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridViewTraducciones.CellEndEdit
        ...
        Dim PalabraTraducida As BE.PALABRATRADUCIDA = DataGrid.Rows(e.RowIndex).Tag
