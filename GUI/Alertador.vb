Public Class Alertador
    ...
    Private Shared _IdiomaViejo As BE.IDIOMA = New BE.IDIOMA(Nothing, "Español", True)
    Private Shared _IdiomaNuevo As BE.IDIOMA = New BE.IDIOMA(Nothing, "Español", True)
    ...
    Public Shared Sub ActualizarIdiomas(pIdiomaNuevo As BE.IDIOMA, pIdiomaViejo As BE.IDIOMA)
